...
[![npm package](https://badgen.net/npm/v/@vrn-deco/boilerplate-rust-napi-rs)](https://www.npmjs.com/package/@vrn-deco/boilerplate-rust-napi-rs)
...
```sh
npx @vrn-deco/boilerplate-rust-napi-rs \
