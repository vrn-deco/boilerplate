# `@vrn-deco/boilerplate-typescript-monorepo-pnpm-vite`

[![npm package](https://badgen.net/npm/v/@vrn-deco/boilerplate-typescript-monorepo-pnpm-vite)](https://www.npmjs.com/package/@vrn-deco/boilerplate-typescript-monorepo-pnpm-vite)
...
```sh
npx @vrn-deco/boilerplate-typescript-monorepo-pnpm-vite \
