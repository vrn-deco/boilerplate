<template>
<uni-shadow-root class="image-cropper-index"><view class="image-cropper" @touchmove.stop.prevent="_preventTouchMove">
...
global['__wxRoute'] = 'image-cropper/index'
Component({
  properties: {
    /**     
     * 图片路径
...
export default global['__wxComponents']['image-cropper/index']
</script>
